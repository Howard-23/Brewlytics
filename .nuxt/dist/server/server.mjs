...
import { $fetch } from "C:/Users/LEGION/Downloads/New folder/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks, createDebugger } from "C:/Users/LEGION/Downloads/New folder/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/LEGION/Downloads/New folder/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/LEGION/Downloads/New folder/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/Users/LEGION/Downloads/New folder/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "C:/Users/LEGION/Downloads/New folder/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CGn25Caa.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-_Yd_Soem.js")
  },
  {
    name: "analytics",
    path: "/analytics",
    component: () => import("./_nuxt/analytics-DKkjQNkz.js")
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import("./_nuxt/customers-D8JIQr5W.js")
  },
  {
    name: "inventory",
    path: "/inventory",
    component: () => import("./_nuxt/inventory-BTKPlBeY.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CsUzJxL2.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CkvVs-nW.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-COK9x373.js"));
