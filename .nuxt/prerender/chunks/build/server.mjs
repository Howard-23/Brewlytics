import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/build/server');import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks, createDebugger } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/LEGION/Downloads/New%20folder/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CGn25Caa.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./orders-_Yd_Soem.mjs')
  },
  {
    name: "analytics",
    path: "/analytics",
    component: () => import('./analytics-DKkjQNkz.mjs')
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import('./customers-D8JIQr5W.mjs')
  },
  {
    name: "inventory",
    path: "/inventory",
    component: () => import('./inventory-BTKPlBeY.mjs')
  }
];
...
function shouldPrerender(path) {
  return !!routeRulesMatcher$1(path).prerender;
}
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CsUzJxL2.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CkvVs-nW.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-COK9x373.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
